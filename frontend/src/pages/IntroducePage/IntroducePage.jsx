...
function IntroducePage() {
    return ( 
      ...
      <header className="w-full bg-white shadow-md p-4 flex justify-between items-center">
        ...
        <nav>
          <button className="bg-transparent hover:underline text-pink-600">Đăng nhập</button>
          <button className="border border-pink-600 text-pink-600 px-4 py-2 rounded hover:bg-pink-600 hover:text-white ml-2">Đăng ký</button>
        </nav>
      </header>
      ...
      <main className="flex flex-col items-center mt-10">
        ...
        <button className="bg-pink-500 text-white px-6 py-3 rounded-lg hover:bg-pink-600">Bắt đầu ngay</button>
